...
const GamesInformation: GameInfoItem[] = [
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/63/986/636148993918069601.png",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/760/638054972345226215.png",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/756/638054971315935359.png",
    },
    {
        id: 68,
        name: "Fallout 3",
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2945198896"
                target="_blank"
            >
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/76/698/636173120361240569.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/77/677/636174916166063366.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/751/638054969923607845.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/65/488/636162973579653614.png",
    },
    {
        id: 432,
        name: "Minecraft",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/748/638054969446166748.png",
        appWeb: [AppWeb.Standalone, AppWeb.OverwolfApp, AppWeb.Web],
        os: [
    ...
    },
    {
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=741846155"
                target="_blank"
            >
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/77/689/636174976208356224.png",
        appWeb: [AppWeb.Web],
        os: [OperatingSystem.Windows],
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/762/638054972820516108.png",
    },
    {
        id: 455,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/77/188/636173283407439352.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
        ...
        avatarUrl: null,
        os: [OperatingSystem.Windows, OperatingSystem.Linux],
        appWeb: [AppWeb.Unknown],
        info: (
            <>
                Looks like{" "}
                <a
                    href="https://steamcommunity.com/sharedfiles/filedetails/?id=2009480990"
                    target="_blank"
                >
                    3rd party tools
                </a>{" "}
    ...
    },
    {
        ...
        info: (
            <>
                Mods are available on Nexus and{" "}
                <a href="https://www.gta5-mods.com/" target="_blank">
                    GTA5-Mods
                </a>
            </>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/375/747/637551180022713994.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
            OperatingSystem.Linux,
        ...
        info: (
            <>
                Steam Workshop and{" "}
                <a href="https://truckymods.io/" target="_blank">
                    Trucky Mods
                </a>
            </>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/736/638054965886871014.png",
        appWeb: [AppWeb.Web],
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
        ...
        info: (
            <>
                You should use{" "}
                <a
                    href="https://7daystodiemods.com/how-to-install-7-days-to-die-mods/"
                    target="_blank"
                >
                    this guide to install mods
                </a>
            </>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/742/638054967772267278.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
        info: (
            <a
                href="https://catalogue.smods.ru/how-to-install-mods-for-darkest-dungeon"
                target="_blank"
            >
                Info on how to install mods
            </a>
        ),
    },
    {
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/744/638054968700723608.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <a
                href="https://wiki.nexusmods.com/index.php/Fallout_4_Mod_Installation"
                target="_blank"
            >
    ...
    },
    {
        ...
        image: null,
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/743/638054968335915948.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
            OperatingSystem.Linux,
        ...
        info: (
            <a
                href="https://wiki.factorio.com/index.php?title=Installing_Mods"
                target="_blank"
            >
                How to install mods
            </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/144/99/636553639128471675.png",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/740/638054967355252694.png",
    },
    {
        id: 732,
        name: "Planet Coaster",
    ...
    },
    {
        ...
        info: (
            <>
                ...
                <a
                    href={"https://github.com/KSP-CKAN/CKAN/wiki/User-guide"}
                    target={"_blank"}
                >
                    CKAN
                </a>{" "}
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/754/638054970768371241.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/752/638054970104094271.png",
    },
    {
        id: 4593,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/810/300/638181947470265030.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
    ...
    },
    {
        ...
        image: "",
        avatarUrl:
            "https://media.forgecdn.net/avatars/367/291/637533957149291522.png",
    },
    {
        id: 4619,
        name: "The Last of Us",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/3/638155844409162919.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Unknown],
        info: (
            <a
                href="https://www.nexusmods.com/thelastofuspart1/mods/8"
                target="_blank"
            >
                Fluffy Mod Manager
            </a>
    ...
    },
    {
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2787588996"
                target="_blank"
            >
                FF4: Complete Modding Guide and Index
            </a>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/745/638054968911430508.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
                <a
                    href="https://steamcommunity.com/sharedfiles/filedetails/?id=2788537097"
                    target="_blank"
                >
                    FF6: Complete Modding Guide and Index
                </a>
                ,{" "}
                <a
                    href="https://www.nexusmods.com/finalfantasy6/articles/2"
                    target="_blank"
                >
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/739/638054967147418836.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
            OperatingSystem.Linux,
        ...
        info: (
            <>
                Use{" "}
                <a
                    href="https://truckymods.io/standalone-client"
                    target="_blank"
                >
                    Trucky Desktop Mods Manager
                </a>{" "}
                to install and handle mods, or Steam Workshop
            </>
        ),
    },
    {
    ...
    },
    {
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2787152070"
                target="_blank"
            >
                FF2: Complete Modding Guide and Index
            </a>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/832/380/638223324483858481.png",
    },
    {
        id: 5021,
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2788533275"
                target="_blank"
            >
                FF5: Complete Modding Guide and Index
            </a>
        ),
    },
    {
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2787489586"
                target="_blank"
            >
                FF3: Complete Modding Guide and Index
            </a>
        ),
    },
    {
        ...
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2786697005"
                target="_blank"
            >
                FF1: Complete Modding Guide and Index
            </a>
        ),
    },
    {
        ...
        info: <i>Unknown on how to mod, probably outdated?</i>,
    },
    {
        id: 6351,
        name: "Mario Party 3",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/832/385/638223328928872194.png",
    },
    {
        id: 6647,
    ...
    },
    {
        ...
        info: (
            <>
                <a
                    href="https://bigpharma.fandom.com/wiki/Modding"
                    target="_blank"
                >
                    Info on how to mod
                </a>
                , and{" "}
                <a
                    href="https://www.bigpharmagame.com/modding.html"
                    target="_blank"
                >
                    how to install mods
                </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/790/442/638145863053235035.png",
    },
    {
        id: 8612,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/375/780/637551299565475836.png",
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
        appWeb: [AppWeb.Unknown],
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?l=english&id=626346497"
                target="_blank"
            >
                Information on how to mod ETS
            </a>
        ),
    },
    {
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/441/265/637691143245487828.png",
    },
    {
        id: 11805,
        name: "Zoo Tycoon 2",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/757/638054971551039662.png",
    },
    {
        id: 22184,
        name: "New World",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/442/522/637694477795475156.jpeg",
    },
    {
        id: 22191,
        name: "Frostpunk",
    ...
    },
    {
        ...
        info: (
            <i>We have no info on this, authors can create projects for this</i>
        ),
    },
    {
        id: 51667,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/26/638155866447620482.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/720/638054901333002711.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Unknown],
        info: <i>Manual installation of "Pak"-files</i>,
    },
    {
        id: 57972,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/783/706/638131894303274679.png",
    },
    {
        id: 58024,
        name: "Vintage Story",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/746/638054969068288078.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
                CF Site, Follow devs instructions,{" "}
                <a
                    href="https://www.youtube.com/watch?v=qDuF_TlzoIU&ab_channel=BestInSlot"
                    target="_blank"
                >
                    https://www.youtube.com/watch?v=qDuF_TlzoIU&ab_channel=BestInSlot
                </a>
            </>
        ),
    },
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/758/638054971686927279.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
        ...
        info: (
            <>
                ...
                ,{" "}
                <a
                    href="https://steamcommunity.com/app/787860/discussions/0/1741103267287272272/"
                    target="_blank"
                >
                    How to mod?
                </a>
    ...
    },
    {
        ...
        info: (
            <>
                <a
                    href="https://www.nexusmods.com/fallout76/articles/42"
                    target="_blank"
                >
                    Nexus
                </a>
                ,{" "}
                <a
                    href="https://www.makeuseof.com/how-to-install-mods-fallout-76/"
                    target="_blank"
                >
                    MakeUseOf Guide
                </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/862/875/638271731220060882.png",
    },
    {
        id: 66022,
        name: "Satisfactory",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/753/638054970481595117.png",
    },
    {
        id: 67850,
        name: "Bloons TD 6",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/343/611/637488990211647743.png",
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
        appWeb: [AppWeb.Unknown],
        info: (
            <>
                Needs Steam version,{" "}
                <a
                    href="https://hemisemidemipresent.github.io/btd6-modding-tutorial/"
                    target="_blank"
                >
                    modding info
                </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/347/212/637496802815720222.png",
    },
    {
        id: 69073,
        name: "Megaquarium",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/405/206/637616842892684035.png",
    },
    {
        id: 69271,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/749/638054969632688688.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/737/638054966435845908.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <a
                href="https://support.curseforge.com/en/support/solutions/articles/9000198451-how-to-install-and-play-among-us-mods"
                target="_blank"
            >
                How to install mods
            </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/741/638054967544087957.png",
        appWeb: [AppWeb.OverwolfApp, AppWeb.Web],
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
    },
    {
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/553/496/637894185157386317.png",
    },
    {
        id: 72458,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/862/894/638271743496364735.png",
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
        appWeb: [AppWeb.Web],
        info: <i>Mods are installed by dropping into Mods-folder</i>,
    },
    {
        id: 73492,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/777/919/638121496998142658.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/782/847/638130162244935608.png",
    },
    {
        id: 76592,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/367/290/637533957076536609.png",
    },
    {
        id: 77546,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/761/638054972647060432.png",
    },
    {
        id: 77548,
        name: "Returnal",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/777/965/638121555152445726.png",
    },
    {
        id: 78017,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/341/135/637483823201039296.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/750/638054969797838185.png",
    },
    {
        id: 78019,
        name: "Loop Hero",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/352/5/637507030455736482.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
            OperatingSystem.Linux,
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/316/638053973637065420.png",
    },
    {
        id: 78023,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/759/638054971844731915.png",
    },
    {
        id: 78062,
        name: "The Sims 4",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/315/638053972646247897.png",
    ...
    },
    {
        ...
        info: (
            <a
                href="https://github.com/orendain/DemeoMods/wiki#installation"
                target="_blank"
            >
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/738/638054966690576901.png",
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/956/638188908760737515.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: <>CF Site and Steam Workshop</>,
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/832/365/638223290755614364.png",
    },
    {
        id: 80214,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/652/755/638054971128354585.png",
    },
    {
        id: 80345,
        name: "Dwerve",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/591/603/637962707596791305.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.Mac,
            OperatingSystem.Linux,
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/640/29/638041271386728785.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/637/492/638040456650718198.png",
    },
    {
        id: 82203,
        name: "Conquer Online",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/798/17/638159578481828194.png",
        os: [OperatingSystem.Unknown],
        appWeb: [AppWeb.Unknown],
        info: (
            <i>
                This seems to be an MMORPG, where people cheat using mods? Very
                much Pay-to-Win.
            </i>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/777/923/638121504952212695.png",
    },
    {
        id: 83372,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/780/500/638125881162863709.png",
    },
    {
        id: 83374,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/858/778/638264250839731334.png",
        os: [
            OperatingSystem.Windows,
            OperatingSystem.PlayStation,
            OperatingSystem.Xbox,
        ...
        info: (
            <>
                Modding is done from{" "}
                <a
                    href="https://support.curseforge.com/en/support/solutions/articles/9000232983-how-to-install-ark-survival-ascended-mods-in-game"
                    target="_blank"
                >
                    in-game
                </a>{" "}
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/783/687/638131883823044612.png",
    },
    {
        id: 83388,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/783/695/638131888835880785.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2946936025"
                target="_blank"
            >
                Modding Guide
            </a>
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/790/427/638145858892250019.png",
    },
    {
        id: 83432,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/790/448/638145866351058890.png",
    },
    {
        id: 83444,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/792/181/638149069838549803.png",
    },
    {
        id: 83445,
        name: "V Rising",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/792/684/638149954983943205.png",
    },
    {
        id: 83452,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/15/638155854691369224.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
                Mods also available on Nexus and{" "}
                <a href="https://modworkshop.net/g/crimeboss" target="_blank">
                    Modworkshop
                </a>
            </>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/16/638155857198979824.png",
    },
    {
        id: 83454,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/32/638155871377903623.png",
    },
    {
        id: 83457,
        name: "Redfall",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/501/638156733343035668.png",
    },
    {
        id: 83461,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/643/638157025363494516.png",
        os: [OperatingSystem.Windows, OperatingSystem.Mac],
        appWeb: [AppWeb.Unknown],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/651/638157031015937085.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
    ...
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/796/657/638157034045226097.png",
    },
    {
        id: 83634,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/812/602/638186253706079500.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Unknown],
        info: (
            <a
                href="https://steamcommunity.com/sharedfiles/filedetails/?id=2980797677"
                target="_blank"
            >
                Manual installation or via Steam
            </a>
        ),
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/412/638187958674631959.png",
    },
    {
        id: 83645,
        name: "Terra Nil",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/433/638187979353957449.png",
    },
    {
        id: 83647,
        name: "Brinefall",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/459/638187994049346597.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/486/638188007582128223.png",
    },
    {
        id: 83649,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/813/495/638188013381130265.png",
    },
    {
        id: 83871,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/835/307/638226857152233219.png",
    },
    {
        id: 84062,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/862/643/638271244666920150.png",
    },
    {
        id: 84137,
        name: "Tennis Elbow 4",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/861/359/638268958862786751.png",
    },
    {
        id: 84438,
        name: "Trine 5",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/884/756/638319356679803277.png",
    },
    {
        id: 84439,
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/884/770/638319361483517457.png",
    },
    {
        id: 84932,
        name: "MINIcraft",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/921/420/638385808600378270.png",
    },
    {
        id: 85196,
        name: "Palworld",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/936/141/638413534976321166.jpg",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Standalone, AppWeb.OverwolfApp, AppWeb.Web],
        info: <i>Does not behave well with Microsoft Gamepass</i>,
    },
    {
        id: 85440,
        name: "Helldivers 2",
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/952/28/638441936476298295.png",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Unknown],
    },
    {
        ...
        avatarUrl:
            "https://media.forgecdn.net/avatars/981/997/638489322552047262.png",
        appWeb: [AppWeb.Web],
        os: [OperatingSystem.Windows],
        info: (
            <a
                href="https://www.youtube.com/watch?v=b92QFUw1iL4&ab_channel=MultiDarkZen"
                target="_blank"
            >
                Modding Guide
            </a>
    ...
    },
    {
        ...
        image: "https://media.forgecdn.net/game-box-art/87913_d11689b8-643e-48b7-be11-162aed829cc2.webp",
        avatarUrl:
            "https://media.forgecdn.net/avatars/1064/287/638597465341275390.webp",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: (
            <>
                Mods are available on{" "}
                <a
                    href="https://www.nexusmods.com/blackmythwukong"
                    target="_blank"
                >
                    Nexus
                </a>
    ...
    },
    {
        ...
        image: "https://media.forgecdn.net/game-box-art/88042_d9d3a3e1-febb-4158-88d2-e3379a1f4116.webp",
        avatarUrl:
            "https://media.forgecdn.net/avatars/1072/606/638608587285850600.webp",
        os: [OperatingSystem.Windows],
        appWeb: [AppWeb.Web],
        info: <i>Unknown on how mods are made and installed as of yet</i>,
    },
    {
        id: 88044,
        name: "Avowed",
        image: "https://media.forgecdn.net/game-box-art/88044_5a13dbcf-73bd-4ae0-9810-2122cfdaafc2.webp",
        avatarUrl:
            "https://media.forgecdn.net/avatars/1072/635/638608605127616799.webp",
        appWeb: [AppWeb.Web],
        os: [OperatingSystem.Windows],
    },
];
