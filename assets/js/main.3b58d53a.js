(self["webpackChunkwebsite"] = self["webpackChunkwebsite"] || []).push([[411],{
 ...
 */function useTitleFormatter(title){const{siteConfig}=(0,useDocusaurusContext/* default */.A)();const{title:siteTitle,titleDelimiter}=siteConfig;return title!=null&&title.trim().length?`${title.trim()} ${titleDelimiter} ${siteTitle}`:siteTitle;}
...
var react_router = __webpack_require__(2681);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function SkipToContent(){const{containerRef,handleSkip}=useSkipToContent();return/*#__PURE__*/react.createElement("div",{ref:containerRef,role:"region"},/*#__PURE__*/react.createElement("a",{href:"#",className:styles_module.skipToContent,onClick:handleSkip},/*#__PURE__*/react.createElement(Translate/* default */.A,{id:"theme.common.skipToMainContent",description:"The skip to content label used for accessibility, allowing to rapidly navigate to main content with keyboard tab/enter navigation"},"Skip to main content")));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function AnnouncementBar(){const{isActive,close}=(0,contexts_announcementBar/* useAnnouncementBar */.Mj)();const{announcementBar}=(0,useThemeConfig/* useThemeConfig */.p)();if(!isActive){return null;}const{content,backgroundColor,textColor,isCloseable}=announcementBar;return/*#__PURE__*/react.createElement("div",{className:AnnouncementBar_styles_module.announcementBar,style:{backgroundColor,color:textColor},role:"banner"},isCloseable&&/*#__PURE__*/react.createElement("div",{className:AnnouncementBar_styles_module.announcementBarPlaceholder}),/*#__PURE__*/react.createElement("div",{className:AnnouncementBar_styles_module.announcementBarContent// Developer provided the HTML, so assume it's safe.
// eslint-disable-next-line react/no-danger
,dangerouslySetInnerHTML:{__html:content}}),isCloseable?/*#__PURE__*/react.createElement("button",{type:"button",className:(0,clsx_m/* default */.A)('clean-btn close',AnnouncementBar_styles_module.announcementBarClose),onClick:close,"aria-label":(0,Translate/* translate */.T)({id:'theme.AnnouncementBar.closeButtonAriaLabel',message:'Close',description:'The ARIA label for close button of announcement bar'})},/*#__PURE__*/react.createElement(IconClose,{width:14,height:14,strokeWidth:3.1})):null);}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const dropdownLinkActiveClass='dropdown__link--active';function NavbarNavLink(_ref){var _props$className;let{activeBasePath,activeBaseRegex,to,href,label,html,activeClassName='',prependBaseUrlToHref,...props}=_ref;// TODO all this seems hacky
...
const linkContentProps=html?{dangerouslySetInnerHTML:{__html:html}}:{children:/*#__PURE__*/react.createElement(react.Fragment,null,label,isExternalLink&&/*#__PURE__*/react.createElement(IconExternalLink/* default */.A,isDropdownLink&&{width:12,height:12}))};if(href){return/*#__PURE__*/react.createElement(Link/* default */.A,(0,esm_extends/* default */.A)({href:prependBaseUrlToHref?normalizedHref:href},props,linkContentProps));}return/*#__PURE__*/react.createElement(Link/* default */.A,(0,esm_extends/* default */.A)({to:toUrl,isNavLink:true,activeClassName:!((_props$className=props.className)!=null&&_props$className.includes(activeClassName))?activeClassName:''},(activeBasePath||activeBaseRegex)&&{isActive:(_match,location)=>activeBaseRegex?isRegexpStringMatch(activeBaseRegex,location.pathname):location.pathname.startsWith(activeBaseUrl)},props,linkContentProps));}
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function DefaultNavbarItemDesktop(_ref){let{className,isDropdownItem=false,...props}=_ref;const element=/*#__PURE__*/react.createElement(NavbarNavLink,(0,esm_extends/* default */.A)({className:(0,clsx_m/* default */.A)(isDropdownItem?'dropdown__link':'navbar__item navbar__link',className)},props));if(isDropdownItem){return/*#__PURE__*/react.createElement("li",null,element);}return element;}function DefaultNavbarItemMobile(_ref2){let{className,isDropdownItem,...props}=_ref2;return/*#__PURE__*/react.createElement("li",{className:"menu__list-item"},/*#__PURE__*/react.createElement(NavbarNavLink,(0,esm_extends/* default */.A)({className:(0,clsx_m/* default */.A)('menu__link',className)},props)));}function DefaultNavbarItem(_ref3){let{mobile=false,position,// Need to destructure position from props so that it doesn't get passed on.
...props}=_ref3;const Comp=mobile?DefaultNavbarItemMobile:DefaultNavbarItemDesktop;return/*#__PURE__*/react.createElement(Comp,(0,esm_extends/* default */.A)({},props,{activeClassName:props.activeClassName??getInfimaActiveClassName(mobile)}));}
...
if(doc===null){return null;}const activeDocInfimaClassName=getInfimaActiveClassName(props.mobile);return/*#__PURE__*/react.createElement(DefaultNavbarItem,(0,esm_extends/* default */.A)({exact:true},props,{className:(0,clsx_m/* default */.A)(props.className,{// Do not make the item active if the active doc doesn't have sidebar.
...
(activeDoc==null?void 0:activeDoc.sidebar)&&activeDoc.sidebar===doc.sidebar}),activeClassName:activeDocInfimaClassName,label:staticLabel??doc.id,to:doc.path}));}
...
const versionDoc=(activeDocContext==null?void 0:activeDocContext.alternateDocVersions[version.name])??DocsVersionDropdownNavbarItem_getVersionMainDoc(version);return{isNavLink:true,label:version.label,to:versionDoc.path,isActive:()=>version===(activeDocContext==null?void 0:activeDocContext.activeVersion),onClick:()=>savePreferredVersionName(version.name)};});const items=[...dropdownItemsBefore,...versionLinks,...dropdownItemsAfter];const dropdownVersion=(0,docsUtils/* useDocsVersionCandidates */.Vd)(docsPluginId)[0];// Mobile dropdown is handled a bit differently
...
title,description}=props;(0,useKeyboardNavigation/* useKeyboardNavigation */.J)();return/*#__PURE__*/react.createElement(LayoutProviders,null,/*#__PURE__*/react.createElement(metadataUtils/* PageMetadata */.be,{title:title,description:description}),/*#__PURE__*/react.createElement(SkipToContent,null),/*#__PURE__*/react.createElement(AnnouncementBar,null),/*#__PURE__*/react.createElement(Navbar,null),/*#__PURE__*/react.createElement("div",{className:(0,clsx_m/* default */.A)(ThemeClassNames/* ThemeClassNames */.G.wrapper.main,wrapperClassName)},/*#__PURE__*/react.createElement(ErrorBoundary/* default */.A,{fallback:ErrorPageContent},children)),!noFooter&&/*#__PURE__*/react.createElement(theme_Footer,null));}
...
/* harmony export */ });
/* harmony import */ var _docusaurus_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8193);
 ...
 */function Collapsible(_ref5){let{lazy,...props}=_ref5;const Comp=lazy?CollapsibleLazy:CollapsibleBase;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1__.createElement(Comp,{...props});}
 ...
 */function useSidebarBreadcrumbs(){var _useActivePlugin;const sidebar=(0,docsSidebar/* useDocsSidebar */.t)();const{pathname}=(0,react_router/* useLocation */.zy)();const breadcrumbsOption=(_useActivePlugin=(0,client/* useActivePlugin */.vT)())==null?void 0:_useActivePlugin.pluginData.breadcrumbs;if(breadcrumbsOption===false||!sidebar){return null;}const breadcrumbs=[];function extract(items){for(const item of items){if(item.type==='category'&&((0,routesUtils/* isSamePath */.ys)(item.href,pathname)||extract(item.items))||item.type==='link'&&(0,routesUtils/* isSamePath */.ys)(item.href,pathname)){breadcrumbs.push(item);return true;}}return false;}extract(sidebar.items);return breadcrumbs.reverse();}/**
 ...
 */function useDocRouteMetadata(_ref){let{route,versionMetadata}=_ref;const location=(0,react_router/* useLocation */.zy)();const docRoutes=route.routes;const currentDocRoute=docRoutes.find(docRoute=>(0,react_router/* matchPath */.B6)(location.pathname,docRoute));if(!currentDocRoute){return null;}// For now, the sidebarName is added as route config: not ideal!
const sidebarName=currentDocRoute.sidebar;const sidebarItems=sidebarName?versionMetadata.docsSidebars[sidebarName]:undefined;const docElement=(0,react_router_config/* renderRoutes */.v)(docRoutes,{versionMetadata});return{docElement,sidebarName,sidebarItems};}
...
/* harmony export */ });
/* harmony import */ var _home_runner_work_curseforgecommunity_github_io_curseforgecommunity_github_io_node_modules_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8168);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5489);
/* harmony import */ var _theme_ThemedImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6265);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function Logo(props){const{siteConfig:{title}}=(0,_docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .A)();const{navbar:{title:navbarTitle,logo={src:''}}}=(0,_docusaurus_theme_common__WEBPACK_IMPORTED_MODULE_5__/* .useThemeConfig */ .p)();const{imageClassName,titleClassName,...propsRest}=props;const logoLink=(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(logo.href||'/');const sources={light:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(logo.src),dark:(0,_docusaurus_useBaseUrl__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A)(logo.srcDark||logo.src)};const themedImage=/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_ThemedImage__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,{sources:sources,height:logo.height,width:logo.width,alt:logo.alt||navbarTitle||title});return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Link__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,(0,_home_runner_work_curseforgecommunity_github_io_curseforgecommunity_github_io_node_modules_babel_runtime_helpers_esm_extends_js__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .A)({to:logoLink},propsRest,logo.target&&{target:logo.target}),logo.src&&(imageClassName?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("div",{className:imageClassName},themedImage):themedImage),navbarTitle!=null&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("b",{className:titleClassName},navbarTitle));}
...
/* harmony import */ var _docusaurus_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2681);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
__webpack_require__.d(__webpack_exports__, {
  ...
  dO: () => (/* binding */ Switch),
  XZ: () => (/* binding */ context),
  B6: () => (/* binding */ matchPath),
  W6: () => (/* binding */ useHistory),
  zy: () => (/* binding */ useLocation)
});
...
var esm_history = __webpack_require__(9231);
...
function createReactContext(defaultValue, calculateChangedBits) {
  ...
  var Consumer = /*#__PURE__*/function (_Component2) {
    (0,inheritsLoose/* default */.A)(Consumer, _Component2);
...
var tiny_invariant_esm = __webpack_require__(8997);
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/extends.js
var esm_extends = __webpack_require__(8168);
...
var MemoryRouter = /*#__PURE__*/function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    _this.history = (0,esm_history/* createMemoryHistory */.sC)(_this.props);
    return _this;
  }
...
function Redirect(_ref) {
  ...
  return /*#__PURE__*/react.createElement(context.Consumer, null, function (context) {
    ...
    var location = (0,esm_history/* createLocation */.yJ)(computedMatch ? typeof to === "string" ? generatePath(to, computedMatch.params) : (0,esm_extends/* default */.A)({}, to, {
    ...
    return /*#__PURE__*/react.createElement(Lifecycle, {
      ...
      onUpdate: function onUpdate(self, prevProps) {
        var prevLocation = (0,esm_history/* createLocation */.yJ)(prevProps.to);

        if (!(0,esm_history/* locationsAreEqual */.Fu)(prevLocation, (0,esm_extends/* default */.A)({}, location, {
...
function createURL(location) {
  return typeof location === "string" ? location : (0,esm_history/* createPath */.AO)(location);
}
...
var StaticRouter = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.navigateTo = function navigateTo(location, action) {
    ...
    context.location = addBasename(basename, (0,esm_history/* createLocation */.yJ)(location));
  ...
  _proto.render = function render() {
    ...
    var history = {
      ...
      action: "POP",
      location: stripBasename(basename, (0,esm_history/* createLocation */.yJ)(location)),
    ...
    return /*#__PURE__*/react.createElement(Router, (0,esm_extends/* default */.A)({}, rest, {
      history: history,
...
/* harmony export */ });
/* harmony import */ var react_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2681);
 ...
 */function useScrollPosition(effect,deps){if(deps===void 0){deps=[];}const{scrollEventsEnabledRef}=useScrollController();const lastPositionRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(getScrollPosition());const dynamicEffect=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_3__/* .useDynamicCallback */ .qd)(effect);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{const handleScroll=()=>{if(!scrollEventsEnabledRef.current){return;}const currentPosition=getScrollPosition();if(dynamicEffect){dynamicEffect(currentPosition,lastPositionRef.current);}lastPositionRef.current=currentPosition;};const opts={passive:true};handleScroll();window.addEventListener('scroll',handleScroll,opts);return()=>window.removeEventListener('scroll',handleScroll,opts);// eslint-disable-next-line react-hooks/exhaustive-deps
...
"use strict";
module.exports = /*#__PURE__*/JSON.parse('{"/blog-f10":{"__comp":"a6aa9e1f","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","items":[{"content":"905267d7"},{"content":"464bae62"},{"content":"92a14dc1"}],"metadata":"b2b675dd"},"/blog/2022/05/14/a-page-with-tools-5e2":{"__comp":"ccc49370","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","content":"0b4df70a"},"/blog/2022/08/17/new-tools-added-985":{"__comp":"ccc49370","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","content":"5ed43ce2"},"/blog/2022/12/24/merry-christmas-d4f":{"__comp":"ccc49370","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","content":"50a903f9"},"/blog/archive-0d6":{"__comp":"9e4087bc","__context":{"plugin":"30c3469d"},"archive":"b2f554cd"},"/blog/tags-1e8":{"__comp":"01a85c17","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","tags":"a7023ddc"},"/blog/tags/community-b43":{"__comp":"6875c492","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","items":[{"content":"905267d7"},{"content":"464bae62"},{"content":"92a14dc1"}],"tag":"69b09ea9","listMetadata":"afaff11a"},"/blog/tags/curseforge-25b":{"__comp":"6875c492","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","items":[{"content":"905267d7"},{"content":"464bae62"},{"content":"92a14dc1"}],"tag":"4ea9393e","listMetadata":"b294a587"},"/blog/tags/tools-1a6":{"__comp":"6875c492","__context":{"plugin":"30c3469d"},"sidebar":"814f3328","items":[{"content":"905267d7"},{"content":"464bae62"},{"content":"92a14dc1"}],"tag":"5995366c","listMetadata":"f1db6d6f"},"/games-905":{"__comp":"7e117ab0","__context":{"plugin":"a69ba10e"},"config":"5e9f5e1a"},"/tools-c7f":{"__comp":"1f391b9e","__context":{"plugin":"a69ba10e"},"content":"a7dc6e90"},"/docs-924":{"__comp":"1be78505","__context":{"plugin":"88fbaf37"},"versionMetadata":"935f2afb"},"/docs/-a8c":{"__comp":"17896441","content":"c377a04b"},"/-8f1":{"__comp":"1df93b7f","__context":{"plugin":"a69ba10e"},"config":"5e9f5e1a"}}');
...
/* harmony import */ var react_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(2681);
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2892);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9231);
...
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(8997);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */Object.defineProperty(exports, "__esModule", ({value:true}));exports.getDocVersionSuggestions=exports.getActiveDocContext=exports.getActiveVersion=exports.getLatestVersion=exports.getActivePlugin=void 0;const router_1=__webpack_require__(5567);// This code is not part of the api surface, not in ./theme on purpose
 ...
 */function useLocationChange(onLocationChange){const location=(0,_docusaurus_router__WEBPACK_IMPORTED_MODULE_1__/* .useLocation */ .zy)();const previousLocation=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .usePrevious */ .ZC)(location);const onLocationChangeDynamic=(0,_reactUtils__WEBPACK_IMPORTED_MODULE_2__/* .useDynamicCallback */ .qd)(onLocationChange);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{if(!previousLocation){return;}if(location!==previousLocation){onLocationChangeDynamic({location,previousLocation});}},[onLocationChangeDynamic,location,previousLocation]);}
 ...
 *//* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({"title":"CurseForge Community","tagline":"Welcome to the CurseForge Community","url":"https://cf-community.com","baseUrl":"/","onBrokenLinks":"throw","onBrokenMarkdownLinks":"warn","favicon":"img/favicon.ico","organizationName":"curseforgecommunity","projectName":"curseforgecommunity.github.io","i18n":{"defaultLocale":"en","locales":["en"],"localeConfigs":{}},"scripts":[{"defer":true,"src":"https://user-stats.itssimple.se/script.js","data-website-id":"6dc2e4c5-a19b-4de1-a794-eda6c0611d26"}],"presets":[["classic",{"docs":{"sidebarPath":"/home/runner/work/curseforgecommunity.github.io/curseforgecommunity.github.io/sidebars.js","editUrl":"https://github.com/curseforgecommunity/curseforgecommunity.github.io/tree/main/"},"blog":{"showReadingTime":true,"editUrl":"https://github.com/curseforgecommunity/curseforgecommunity.github.io/tree/main/"},"theme":{"customCss":"/home/runner/work/curseforgecommunity.github.io/curseforgecommunity.github.io/src/css/custom.css"}}]],"themeConfig":{"navbar":{"title":"CurseForge Community","items":[{"to":"/games","position":"left","label":"Games"},{"to":"/tools","position":"left","label":"Tools"},{"to":"/blog","label":"Blog","position":"left"},{"href":"https://github.com/curseforgecommunity/curseforgecommunity.github.io","label":"GitHub","position":"right"}],"hideOnScroll":false},"footer":{"style":"dark","links":[{"title":"Pages","items":[{"label":"Community Tools","to":"/tools"}]},{"title":"Community","items":[{"label":"Discord","href":"https://discord.gg/vBuzrFepcB"}]},{"title":"More","items":[{"label":"Blog","to":"/blog"},{"label":"GitHub","href":"https://github.com/curseforgecommunity/curseforgecommunity.github.io"}]}],"copyright":"Copyright © 2026 CurseForge Community, Built with Docusaurus."},"prism":{"theme":{"plain":{"color":"#393A34","backgroundColor":"#f6f8fa"},"styles":[{"types":["comment","prolog","doctype","cdata"],"style":{"color":"#999988","fontStyle":"italic"}},{"types":["namespace"],"style":{"opacity":0.7}},{"types":["string","attr-value"],"style":{"color":"#e3116c"}},{"types":["punctuation","operator"],"style":{"color":"#393A34"}},{"types":["entity","url","symbol","number","boolean","variable","constant","property","regex","inserted"],"style":{"color":"#36acaa"}},{"types":["atrule","keyword","attr-name","selector"],"style":{"color":"#00a4db"}},{"types":["function","deleted","tag"],"style":{"color":"#d73a49"}},{"types":["function-variable"],"style":{"color":"#6f42c1"}},{"types":["tag","selector","keyword"],"style":{"color":"#00009f"}}]},"darkTheme":{"plain":{"color":"#F8F8F2","backgroundColor":"#282A36"},"styles":[{"types":["prolog","constant","builtin"],"style":{"color":"rgb(189, 147, 249)"}},{"types":["inserted","function"],"style":{"color":"rgb(80, 250, 123)"}},{"types":["deleted"],"style":{"color":"rgb(255, 85, 85)"}},{"types":["changed"],"style":{"color":"rgb(255, 184, 108)"}},{"types":["punctuation","symbol"],"style":{"color":"rgb(248, 248, 242)"}},{"types":["string","char","tag","selector"],"style":{"color":"rgb(255, 121, 198)"}},{"types":["keyword","variable"],"style":{"color":"rgb(189, 147, 249)","fontStyle":"italic"}},{"types":["comment"],"style":{"color":"rgb(98, 114, 164)"}},{"types":["attr-name"],"style":{"color":"rgb(241, 250, 140)"}}]},"additionalLanguages":[],"magicComments":[{"className":"theme-code-block-highlighted-line","line":"highlight-next-line","block":{"start":"highlight-start","end":"highlight-end"}}]},"colorMode":{"defaultMode":"light","disableSwitch":false,"respectPrefersColorScheme":false},"docs":{"versionPersistence":"localStorage","sidebar":{"hideable":false,"autoCollapseCategories":false}},"metadata":[],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3}},"baseUrlIssueBanner":true,"onDuplicateRoutes":"warn","staticDirectories":["static"],"customFields":{},"plugins":[],"themes":[],"stylesheets":[],"clientModules":[],"titleDelimiter":"|","noIndex":false});
...
/* harmony export */ });
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2681);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* harmony import */ var _docusaurus_plugin_content_docs_client__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7712);
...
const memoizedProps=useShallowMemoizedObject(props);(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{// @ts-expect-error: this context is hard to type
...
"use strict";
Object.defineProperty(exports, "__esModule", ({value:true}));exports["default"]=void 0;var _nprogress=_interopRequireDefault(__webpack_require__(5947));__webpack_require__(2209);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */_nprogress.default.configure({showSpinner:false});const delay=200;const clientModule={onRouteUpdate(_ref){let{location,previousLocation}=_ref;if(previousLocation&&location.pathname!==previousLocation.pathname){const progressBarTimeout=window.setTimeout(()=>{_nprogress.default.start();},delay);return()=>window.clearTimeout(progressBarTimeout);}return undefined;},onRouteDidUpdate(){_nprogress.default.done();}};var _default=clientModule;exports["default"]=_default;
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
/* harmony import */ var _theme_Layout__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1323);
/* harmony import */ var _docusaurus_ErrorBoundary__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7788);
/* harmony import */ var _docusaurus_Head__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5260);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_ErrorBoundary__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A// Note: we display the original error here, not the error that we
// captured in this extra error boundary
,{fallback:()=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(ErrorDisplay,{error:error,tryAgain:tryAgain})},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_docusaurus_Head__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement("title",null,"Page Error")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_theme_Layout__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(ErrorDisplay,{error:error,tryAgain:tryAgain})));}
...
"use strict";
var _prism=_interopRequireDefault(__webpack_require__(1258));var _prismIncludeLanguages=_interopRequireDefault(__webpack_require__(9567));function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */__webpack_unused_export__ = ({value:true});exports.HW=exports.zK=__webpack_unused_export__=exports.r7=exports.jh=__webpack_unused_export__=exports.vT=exports.ht=exports.Gy=void 0;const router_1=__webpack_require__(5567);const useGlobalData_1=__webpack_require__(6588);const docsClientUtils_1=__webpack_require__(4733);// Important to use a constant object to avoid React useEffect executions etc.
// see https://github.com/facebook/docusaurus/issues/5089
const StableEmptyObject={};// In blog-only mode, docs hooks are still used by the theme. We need a fail-
// safe fallback when the docs plugin is not in use
const useAllDocsData=()=>(0,useGlobalData_1.useAllPluginInstancesData)('docusaurus-plugin-content-docs')??StableEmptyObject;exports.Gy=useAllDocsData;const useDocsData=pluginId=>(0,useGlobalData_1.usePluginData)('docusaurus-plugin-content-docs',pluginId,{failfast:true});exports.ht=useDocsData;// TODO this feature should be provided by docusaurus core
function useActivePlugin(options){if(options===void 0){options={};}const data=(0,exports.Gy)();const{pathname}=(0,router_1.useLocation)();return(0,docsClientUtils_1.getActivePlugin)(data,pathname,options);}exports.vT=useActivePlugin;function useActivePluginAndVersion(options){if(options===void 0){options={};}const activePlugin=useActivePlugin(options);const{pathname}=(0,router_1.useLocation)();if(!activePlugin){return undefined;}const activeVersion=(0,docsClientUtils_1.getActiveVersion)(activePlugin.pluginData,pathname);return{activePlugin,activeVersion};}__webpack_unused_export__=useActivePluginAndVersion;function useVersions(pluginId){const data=(0,exports.ht)(pluginId);return data.versions;}exports.jh=useVersions;function useLatestVersion(pluginId){const data=(0,exports.ht)(pluginId);return(0,docsClientUtils_1.getLatestVersion)(data);}exports.r7=useLatestVersion;function useActiveVersion(pluginId){const data=(0,exports.ht)(pluginId);const{pathname}=(0,router_1.useLocation)();return(0,docsClientUtils_1.getActiveVersion)(data,pathname);}__webpack_unused_export__=useActiveVersion;function useActiveDocContext(pluginId){const data=(0,exports.ht)(pluginId);const{pathname}=(0,router_1.useLocation)();return(0,docsClientUtils_1.getActiveDocContext)(data,pathname);}exports.zK=useActiveDocContext;function useDocVersionSuggestions(pluginId){const data=(0,exports.ht)(pluginId);const{pathname}=(0,router_1.useLocation)();return(0,docsClientUtils_1.getDocVersionSuggestions)(data,pathname);}exports.HW=useDocVersionSuggestions;
...
if(_docusaurus_ExecutionEnvironment__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A.canUseDOM){this.setState({error});}}render(){const{children}=this.props;const{error}=this.state;if(error){const fallback=this.props.fallback??_theme_Error__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A;return fallback({error,tryAgain:()=>this.setState({error:null})});}return children??// See https://github.com/facebook/docusaurus/issues/6337#issuecomment-1012913647
null;}}
...
if(path==='*'){return lib_default()({loading:Loading,loader:()=>__webpack_require__.e(/* import() */ 90).then(__webpack_require__.bind(__webpack_require__, 9090)).then(_ref=>{let{default:NotFound}=_ref;return props=>/*#__PURE__*/react.createElement(client_routeContext/* RouteContextProvider */.W// Do we want a better name than native-default?
...
const flatChunkNames=(0,flat/* default */.A)(chunkNames);Object.entries(flatChunkNames).forEach(_ref2=>{let[keyPath,chunkName]=_ref2;const chunkRegistry=registry[chunkName];if(chunkRegistry){// eslint-disable-next-line prefer-destructuring
...
// object from scratch.
const loadedModules=JSON.parse(JSON.stringify(chunkNames));Object.entries(loaded).forEach(_ref3=>{let[keyPath,loadedModule]=_ref3;// JSON modules are also loaded as `{ default: ... }` (`import()`
 ...
 */function isSamePath(path1,path2){const normalize=pathname=>{var _ref;return(_ref=!pathname||pathname!=null&&pathname.endsWith('/')?pathname:`${pathname}/`)==null?void 0:_ref.toLowerCase();};return normalize(path1)===normalize(path2);}/**
...
/* harmony export */   qd: () => (/* binding */ useDynamicCallback)
/* harmony export */ });
 ...
 */function useDynamicCallback(callback){const ref=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(callback);useIsomorphicLayoutEffect(()=>{ref.current=callback;},[callback]);// @ts-expect-error: TS is right that this callback may be a supertype of T,
...
/* harmony export */ });
/* harmony import */ var _generated_docusaurus_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5091);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 ...
 */function useHistoryActionHandler(handler){const{block}=(0,react_router/* useHistory */.W6)();const stableHandler=(0,reactUtils/* useDynamicCallback */.qd)(handler);(0,react.useEffect)(// See https://github.com/remix-run/history/blob/main/docs/blocking-transitions.md
...
matches.map(match=>{var _match$route$componen;return(_match$route$componen=match.route.component)==null?void 0:_match$route$componen.preload==null?void 0:_match$route$componen.preload();}));}
...
// user is on saveData
preload(nextLocation.pathname).then(()=>{var _this$routeUpdateClea;(_this$routeUpdateClea=this.routeUpdateCleanupCb)==null?void 0:_this$routeUpdateClea.call(this);this.setState({nextRouteHasLoaded:true});}).catch(e=>console.warn(e));return false;}render(){const{children,location}=this.props;// Use a controlled <Route> to trick all descendants into rendering the old
// location.
...
/******/ __webpack_require__.O(0, [869], () => (__webpack_exec__(9932)));
