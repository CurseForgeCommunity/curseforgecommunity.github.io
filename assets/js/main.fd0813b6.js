...
// user is on saveData
preload(nextLocation.pathname).then(()=>{this.routeUpdateCleanupCb?.();this.setState({nextRouteHasLoaded:true});}).catch(e=>console.warn(e));return false;}render(){const{children,location}=this.props;// Use a controlled <Route> to trick all descendants into rendering the old
// location.
...
/* harmony export */ });
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6347);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */const dropdownLinkActiveClass='dropdown__link--active';function NavbarNavLink(_ref){let{activeBasePath,activeBaseRegex,to,href,label,html,activeClassName='',prependBaseUrlToHref,...props}=_ref;// TODO all this seems hacky
...
const versionDoc=activeDocContext?.alternateDocVersions[version.name]??DocsVersionDropdownNavbarItem_getVersionMainDoc(version);return{isNavLink:true,label:version.label,to:versionDoc.path,isActive:()=>version===activeDocContext?.activeVersion,onClick:()=>savePreferredVersionName(version.name)};});const items=[...dropdownItemsBefore,...versionLinks,...dropdownItemsAfter];const dropdownVersion=(0,docsUtils/* useDocsVersionCandidates */.Vd)(docsPluginId)[0];// Mobile dropdown is handled a bit differently
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9231);
